...
## Project Structure
    ...
    ├── voteing_universe_by_30687  # Django project configurations
...
1. Clone this repo and `cd voteing_universe_by_30687`
...
2. Clone this repo and `cd voteing_universe_by_30687`
